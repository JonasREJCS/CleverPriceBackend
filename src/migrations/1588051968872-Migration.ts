...
export class Migration1588051968872 implements MigrationInterface {
    name = 'Migration1588051968872'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `unidade_de_medida` DROP COLUMN `nomeUnidadeDeMedida`", undefined);
        await queryRunner.query("ALTER TABLE `unidade_de_medida` ADD `nomeUnidadeDeMedida` varchar(255) NOT NULL", undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `unidade_de_medida` DROP COLUMN `nomeUnidadeDeMedida`", undefined);
        await queryRunner.query("ALTER TABLE `unidade_de_medida` ADD `nomeUnidadeDeMedida` int NOT NULL", undefined);
