...
export class Migration1588051920187 implements MigrationInterface {
    name = 'Migration1588051920187'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `preco` ADD `quantidade` decimal(8,2) NOT NULL", undefined);
